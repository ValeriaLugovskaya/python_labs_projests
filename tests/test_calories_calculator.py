...
def test_get_calories_remained():
    ...
    records = [Record(amount=110, comment=",картошка"),
               Record(amount=350, comment="куриный суп"),
               Record(amount=350, comment="плов с бараниной"),
               Record(amount=350, comment="запеченая рыба"),
